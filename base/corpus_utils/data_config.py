...
Original_corpus_dir = '/home/zhaoxj/workspace/nlp/CLS/corpus'
...
Data_tup_map = [(['map_restaurant.data'], 0, 'map_restaurant'),

                (['map_hotel.data'], 1, 'map_hotel'),

                (['map_scenic.data'], 2, 'map_scenic'),

                (['map_cinema.data'], 3, 'map_cinema'),

                (['map.data', 'navigation.data', 'traffic.data', 'mixed_map_basic.data',
                  'map1_encyclopedia.data','map2_encyclopedia.data'], 4, 'map_basic')
                ]

# This tup is define for corpus_Generalization/ticket
Data_tup_ticket = [
    (['air_tickets.data', 'train_tickets.data', 'common_tickets.data', 'mixed_ticket_travel.data'], 0, 'ticket_travel'),

    (['ticket_scenic.data'], 1, 'ticket_scenic'),

    (['ticket_cinema.data'], 2, 'ticket_cinema')
    ]

# This tup is define for corpus_Generalization/order
Data_tup_order = [(['order_food.data', 'order_fresh.data', 'mixed_order_food.data'], 0, 'order_food'),

                  (['order_goods.data'], 1, 'order_goods'),

                  (['order_restaurant.data'], 2, 'order_restaurant'),

                  (['order_hotel.data'], 3, 'order_hotel')
                  ]
...
Data_tup_baike = [(['media_encyclopedia.data','add_media_encyclopedia.data'], 0, 'media_baike'),
